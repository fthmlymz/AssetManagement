...
#[cfg(feature = "db")]
use diesel::{backend::Backend, deserialize, serialize, sql_types::Jsonb, AsExpression, FromSqlRow};
#[cfg(feature = "db")]
...
#[cfg_attr(feature = "db", derive(AsExpression, FromSqlRow), diesel(sql_type = Jsonb))]
#[serde(transparent)]
...
#[cfg(feature = "db")]
impl<T: Debug + Clone, DB: Backend> FromSql<Jsonb, DB> for AnyValue<T>
where
...
#[cfg(feature = "db")]
impl<T: Debug + Clone> ToSql<Jsonb, DB> for AnyValue<T>
where
  ...
  T: Serialize,
{
  fn to_sql<'b>(&'b self, out: &mut Output<'b, '_, DB>) -> serialize::Result {
    ...
    <serde_json::Value as ToSql<Jsonb, DB>>::to_sql(&value, &mut out.reborrow())
  }
}
