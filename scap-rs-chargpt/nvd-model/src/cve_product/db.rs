...
use crate::DB;
use diesel::{
    BelongingToDsl, ExpressionMethods, Insertable, PgConnection, QueryDsl, RunQueryDsl, TextExpressionMethods,
};
...
#[diesel(table_name = cve_product)]
pub struct CreateCveProductByVendorProduct {
  pub cve_id: String,
  pub product_id: Vec<u8>,
}
...
impl CveProduct {
  // 创建CVE和产品关联
  pub fn create(conn: &mut PgConnection, args: &CreateCveProduct) -> DBResult<Self> {
